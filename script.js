...
const pdfPaths = {
    abacus: {
        f0: {
            ...
            files: [
                { name: 'Catly版 本番形式001-072', file: 'Catly版_F0本番形式001-072.pdf' },
                { name: 'Catly版 ミニ001-030', file: 'Catly版F0ミニ_Ａ４サイズ_001-030.pdf' },
                { name: 'ザ春合宿2022版', file: 'F0_ザ春合宿2022版.pdf' },
                { name: 'ピコ版 第1-24回', file: 'F0_ピコ版_第1回-第24回_解答付.pdf' },
                { name: 'ピコ版 第25-48回', file: 'F0_ピコ版_第25回-第48回_解答付.pdf' },
        ...
        f1: {
            ...
            files: [
                ...
                { name: 'Catly版 ミニ001-040', file: 'Catly版F1ミニ_Ａ４サイズ_001-040.pdf' },
                { name: 'ザ春合宿2022版', file: 'F1_ザ春合宿2022版.pdf' },
                { name: 'ピコ版 第1-24回', file: 'F1_ピコ版_第1回-第24回_解答付.pdf' },
                { name: 'ピコ版 第25-48回', file: 'F1_ピコ版_第25回-第48回_解答付.pdf' },
                { name: 'ピコ版 第49-72回', file: 'F1_ピコ版_第49回-第72回_解答付.pdf' },
                { name: 'ピコ版 第73-80回', file: 'F1_ピコ版_第73回-第80回_解答付.pdf' },
        ...
        f2: {
            ...
            files: [
                ...
                { name: 'ザ春合宿2022版', file: 'F2_ザ春合宿2022版.pdf' },
                { name: 'ピコ版 第2集問題', file: 'F2_ピコ版_第2集問題24回分.pdf' },
                { name: 'ピコ版 第2集解答', file: 'F2_ピコ版_第2集解答.pdf' }
            ]
        },
        past: {
            isFolder: true,
            ...
            files: [
                { name: '第283回（解答付）', file: '283_解答付.pdf' },
                { name: '第284回（解答付）', file: '284_解答付.pdf' },
                { name: '第285回（解答付）', file: '285_解答付.pdf' },
                { name: '第286回（解答付）', file: 'PDF286_解答付.pdf' },
                { name: '第287回（解答付）', file: '287_解答付.pdf' },
                { name: '第288回（解答付）', file: '288_解答付.pdf' },
                { name: '第289回（解答付）', file: '289_解答付.pdf' },
                { name: '第290回（解答付）', file: '290_解答付.pdf' },
        ...
        color: {
            ...
            files: [
                ...
                { name: 'Lv.1 F2 001-020', file: 'カラコン_Lv.1_F2_001-020.pdf' },
                { name: 'Lv.2 黄 001-020', file: 'カラコン_Lv.2_黄_001-020.pdf' },
                { name: 'Lv.3 緑 001-020', file: 'カラコン_Lv.3_緑_001-020.pdf' },
                { name: 'Lv.4 赤 001-020', file: 'カラコン_Lv.4_赤_001-020.pdf' },
                { name: 'Lv.5 青 001-020', file: 'カラコン_Lv.5_青_001-020.pdf' },
                { name: 'Lv.6 黒 001-020', file: 'カラコン_Lv.6_黒_001-020.pdf' },
                { name: 'Lv.7 金 001-020', file: 'カラコン_Lv.7_金_001-020.pdf' },
                { name: 'Lv.8 難 001-020', file: 'カラコン_Lv.8_難_001-020.pdf' },
                { name: 'Lv.9 激 001-020', file: 'カラコン_Lv.9_激_001-020.pdf' },
                { name: 'Lv.10 変 001-020', file: 'カラコン_Lv.10_変_001-020.pdf' },
                { name: 'Lv.11 狂 001-020', file: 'カラコン_Lv.11_狂_001-020.pdf' },
                { name: 'Lv.12 神 001-020', file: 'カラコン_Lv.12_神_001-020.pdf' }
            ]
        }
    },
    sorocon: {
